...
#| include: false
#libraries
library(multcomp)  # This will load MASS automatically
library(MASS)      # Not strictly needed, but good to be explicit

# 2. Load tidyverse AFTER. This is the key.
#    It will "mask" MASS::select with dplyr::select, which caret needs.
library(tidyverse) 

# 3. Load caret and other packages
library(caret)
